...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    window.createMovieCard = (pelicula, showDescription = true, highlightQuery = '') => {
        ...
        const ratingTag = pelicula.calificacion ? `<div class="card-tag tag-rating"><i class="fas fa-star"></i> ${Number(pelicula.calificacion).toFixed(1)}</div>` : '';
        ...
        tarjeta.innerHTML = `
            ${vipTag}${ratingTag}${plataformaTag}${nuevoTag}${recienteTag}${mostViewedTag}${edadTag}${tipoTag}${nuevaTemporadaTag}${prontoTemporadaTag}
