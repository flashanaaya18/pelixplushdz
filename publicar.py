...
FILES_CONFIG = [
    ...
    {'path': os.path.join(BASE_DIR, 'peliculas', 'peliculas2.js'), 'var': 'peliculas2'},
    {'path': os.path.join(BASE_DIR, 'peliculas', 'peliculas3.js'), 'var': 'peliculas3'}
]
REPORTS_FILE = os.path.join(BASE_DIR, 'reports.json')
PROXIMAMENTE_FILE = os.path.join(BASE_DIR, 'proximamente.json')
BASE_DATOS_FILE = os.path.join(BASE_DIR, 'base_datos.json')
SOLICITUDES_FILE = os.path.join(BASE_DIR, 'solicitudes.json')
MAINTENANCE_FLAG = os.path.join(BASE_DIR, 'maintenance.flag')
CAMPAIGN_FILE = os.path.join(BASE_DIR, 'campaña_proximamente.txt')
PELINOT_JS_FILE = os.path.join(BASE_DIR, 'pelinot.js')
NOTIFICACIONES_FILE = os.path.join(BASE_DIR, 'lanzamientos_notificaciones.json')
VIP_USERS_FILE = os.path.join(BASE_DIR, 'codigos_vip.json')
...
def gestionar_destacados():
    ...
    if confirmar_accion(f"\n¿Añadir '{titulo}' a destacados en script.js?"):
        try:
            ruta_script = os.path.join(BASE_DIR, 'script.js')
